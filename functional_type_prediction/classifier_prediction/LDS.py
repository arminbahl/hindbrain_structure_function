...
features = np.array(without_nan_function.loc[:, without_nan_function.columns[3:]])
features_pa = np.array(without_nan_function.loc[without_nan_function['imaging_modality'] == 'photoactivation', without_nan_function.columns[3:]])
features_clem = np.array(without_nan_function.loc[without_nan_function['imaging_modality'] == 'clem', without_nan_function.columns[3:]])
