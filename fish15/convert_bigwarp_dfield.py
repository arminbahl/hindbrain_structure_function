...
transforms_path = Path("/Users/arminbahl/Nextcloud/CLEM_paper_data/clem_zfish1/transforms/clem_zfish1_to_zbrain_012524")
...
ants_registration.ANTs_applytransform(source_path=transforms_path / "EM_stack_lowres_cropped.nrrd",
                                      target_path=transforms_path / "Elavl3-H2BRFP.nrrd",
                                      output_path=transforms_path / "EM_stack_lowres_cropped_mapped.nrrd",
...
ants_registration.ANTs_applytransform(source_path=transforms_path / "Elavl3-H2BRFP.nrrd",
                                      target_path=transforms_path / "EM_stack_lowres_cropped.nrrd",
                                      output_path=transforms_path / "EM_stack_lowres_cropped_mapped_inverse.nrrd",
                                      transformation_prefix_path=transforms_path / "ANTs_dfield",
