...
# for selected_cells,filename in zip([dynamic_thresholds,
#                                     motors,
#                                     integrators,
#                                     integrators_group_crossing_going_caudal,
#                                     integrators_group_crossing,
#                                     integrators_group_weird,
#                                     integrators_group_local,"all",single_cell_to_show],['dynamic_thresholds',
#                                     'motors',
#                                     'integrators',
#                                     'integrators_group_crossing_going_caudal',
#                                     'integrators_group_crossing',
#                                     'integrators_group_weird',
#                                     'integrators_group_local',"all",'2023-03-27_17-46-50']):
...
plotly.offline.plot(fig, filename=rf"C:\Users\ag-bahl\Desktop\zbrain_mesh\{filename}.html",auto_open=False,auto_play=False)
...
temp_image = np.array(Image.open(rf"C:\Users\ag-bahl\Desktop\zbrain_mesh\projections\{filename}_z_projection.jpg"))

#xarrow
cv2.arrowedLine(temp_image,
                [int(temp_image.shape[0]*0.975),int(temp_image.shape[1]*0.975)],
                [int(temp_image.shape[0]*0.85),int(temp_image.shape[1]*0.975)],
                (0,0,0),
                thickness=5,
...
cv2.arrowedLine(temp_image,
                [int(temp_image.shape[0]*0.975),int(temp_image.shape[1]*0.975)],
                [int(temp_image.shape[0]*0.975),int(temp_image.shape[1]*0.85)],
                (0,0,0),
                thickness=5,
                line_type=cv2.LINE_AA,
                tipLength=0.05)
cv2.putText(temp_image,
            text = "Y",
            org=[int(temp_image.shape[0]*0.95),int(temp_image.shape[0]*0.915)],
...
cv2.putText(temp_image,
            text = "X",
            org=[int(temp_image.shape[0]*0.91),int(temp_image.shape[0]*0.965)],
            fontFace=cv2.FONT_HERSHEY_SIMPLEX,
            fontScale=2,
            color=(0,0,0),
            thickness=3,
...
imageio.imwrite(rf"C:\Users\ag-bahl\Desktop\zbrain_mesh\projections\{filename}_z_projection_wa.jpg",temp_image)
...
#x arrow
cv2.arrowedLine(temp_image,
                [int(temp_image.shape[0]*0.975),int(temp_image.shape[1]*0.025)],
                [int(temp_image.shape[0]*0.85),int(temp_image.shape[1]*0.025)],
                (0,0,0),
                thickness=5,
                line_type=cv2.LINE_AA,
                tipLength=0.05)
...
cv2.arrowedLine(temp_image,
                [int(temp_image.shape[0]*0.975),int(temp_image.shape[1]*0.025)],
                [int(temp_image.shape[0]*0.975),int(temp_image.shape[1]*0.15)],
                (0,0,0),
                thickness=5,
                line_type=cv2.LINE_AA,
                tipLength=0.05)
cv2.putText(temp_image,
            text = "Z",
            org=[int(temp_image.shape[0]*0.95),int(temp_image.shape[0]*0.095)],
            fontFace=cv2.FONT_HERSHEY_SIMPLEX,
            fontScale=2,
            color=(0,0,0),
            thickness=3,
...
cv2.putText(temp_image,
            text = "X",
            org=[int(temp_image.shape[0]*0.91),int(temp_image.shape[0]*0.055)],
            fontFace=cv2.FONT_HERSHEY_SIMPLEX,
            fontScale=2,
            color=(0,0,0),
            thickness=3,
...
imageio.imwrite(rf"C:\Users\ag-bahl\Desktop\zbrain_mesh\projections\{filename}_y_projection_wa.jpg",temp_image)
